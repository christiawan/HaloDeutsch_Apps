...
public class vocab3 extends Activity {
    ...
    int[] flags = new int[]{
    		R.drawable.lebendasbrot,
    		R.drawable.lebendasbrotchen,
    		R.drawable.lebendasei,
    		R.drawable.lebendasfleisch,
    		R.drawable.lebenderreis,
    		R.drawable.lebendiebanane,
    		R.drawable.lebendiebutter,
    		R.drawable.lebendiechips,
    		R.drawable.lebendiekartoffel,
    		R.drawable.lebendiemilch
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(getBaseContext(), aList, R.layout.listview_layout_vocab3, from, to);
